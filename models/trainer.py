...
class Trainer(object):
    ...
    def _maybe_save_model(self, f1score, epoch):
        if self.best_f1 <= f1score: # save model
            self.best_f1 = f1score
            torch.save(self.model.state_dict(), f'{self.args.model_path}/BEST_Task_{self.args.task}.pt')
            return True
        else:
            return False
